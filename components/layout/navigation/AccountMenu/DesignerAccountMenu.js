  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem onClick={() => setAccountAnchorEl(null)}>
          <Link href={`/${session.id}/add-design`} style={{ width: '100%' }}>
            <Stack
              direction="row"
              alignItems="center"
              gap={1}
              ...
              width="100%"
            >
              <FormatShapesIcon fontSize="small" color="inherit" />
              <Divider orientation="vertical" />
              <Typography color="inherit">Add Design</Typography>
            </Stack>
          </Link>
        </MenuItem>
        <MenuItem onClick={() => setAccountAnchorEl(null)}>
          <Link href={`/${session.id}/add-product`} style={{ width: '100%' }}>
            <Stack
              direction="row"
              alignItems="center"
              gap={1}
              ...
              width="100%"
            >
              <AddBoxIcon fontSize="small" color="inherit" />
              <Divider orientation="vertical" />
...
export default DesignerAccountMenu;
