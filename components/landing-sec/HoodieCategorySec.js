...
const HoodieCategorySec = ({ products }) => {
  ...
  useEffect(() => {
    axiosApi
      .get('/api/products?page=1&type=hoodie')
      .then((res) => {
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        flexBasis="20%"
        sx={{
          backgroundImage: 'url(img/large-white-hoodie.jpg)',
      ...
      >
        ...
        {/* <ImageCategorySec title="Hoodie" url="/shop/category/hoodie/1" /> */}
      </Box>
    </Stack>
  );
};

export default HoodieCategorySec;
